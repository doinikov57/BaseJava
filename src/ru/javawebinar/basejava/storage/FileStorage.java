...
public class FileStorage extends AbstractStorage<File> {
    ...
    protected void doUpdate(File file, Resume resume) {
        try {
            serializationType.writeFile(resume, new BufferedOutputStream(new FileOutputStream(file)));
        } catch (IOException e) {
    ...
    protected Resume doGet(File file) {
        try {
            return serializationType.readFile (new BufferedInputStream (new FileInputStream(file)));
        } catch (IOException e) {
